...
type SidebarCategoriesProps = {
  setSelectedClothesSubCategory: React.Dispatch<React.SetStateAction<string>>;
  setFilterLoading: React.Dispatch<React.SetStateAction<boolean>>;
};
export default function SidebarClothesCategories({
  setSelectedClothesSubCategory,
  setFilterLoading,
          ...
          {clothesSubCategories?.map((sub) => (
            <button
              ...
              onClick={() => {
                ...
                setSelectedClothesSubCategory(sub._id);
